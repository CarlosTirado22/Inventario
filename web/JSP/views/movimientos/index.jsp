          ...
          <table class="table align-items-center mb-0" id="table">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle text-center text-sm">
                    <button class="btn  btn-rounded mb-0 me-3 btn-sm d-flex align-items-center justify-content-center"><i class=""></i>
                    <small class="text-xs font-weight-bold mb-0 ml-1"></small>
                  </button>
                  </td>
