      ...
      <form method="POST" action="<?php echo constant('URL') ?>movimientos/registrarIngreso" autocomplete="off">
        ...
        <div class="row">
          <div class="col-md-2 pr-1">
            <div class="form-group">
              ...
              <input type="text" name="referencia" id="referencia" oninput="buscar_datos();" class="form-control" value="<?php if (isset($this->producto)) {
                                                                                                                            echo $this->producto['referencia'];
                                                                                                                          } ?>" required>
            </div>
          </div>
        ...
        <div class="row">
          <div class="update ml-auto mr-auto">
            <button class="btn bg-gradient-primary mb-0" id="btn-act" disabled>Actualizar</button>
